...
const drodownsList = [
  ...
  },
  {
    title: 'Users',
    icon: <ListIcon />,
    items: [{ to: '/admin/users/add', text: 'Add user', icon: <AddCircleOutline /> }, { to: '/admin/users/list', text: 'Users', icon: <GroupIcon /> }]
  }
];
...
export default function Sidebar() {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <AppBar position="fixed" sx={{ background: "var(--purple)" }} open={open}>
        <Toolbar>
          <IconButton
            color="inherit"
